...
# 18150-trigger-rewind-custom-event
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-trigger-rewind-custom-event.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>custom-event.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>custom-event.css</strong>.</td>
    </tr>
  </tbody>
</table>
